...
<head>
<meta charset="utf-8">
<title>Gazek HTML-5 Template | Contact Us</title>
<!-- Stylesheets -->
...
<div class="page-wrapper">
    ...
    <section class="contact-info-section">
		...
		<div class="auto-container">
			<div class="text">Contact us if you need our services. We will be happy to help you!!</div>
            <div class="row clearfix">
				...
				<div class="info-column col-lg-4 col-md-6 col-sm-12">
					<div class="inner-column">
						...
						<div class="info-text">121 King St, Melbourne <br> VIC - 3000, Australia</div>
					</div>
				</div>
				<!-- End Info Column -->
				...
				<div class="info-column col-lg-4 col-md-6 col-sm-12">
					<div class="inner-column">
						...
						<ul>
							...
							<li><a href="#">support@my-comp.com</a></li>
						</ul>
					</div>
				</div>
				<!-- End Info Column -->
    ...
    <section class="contact-form-section">
		<div class="pattern-icons" style="background-image:url(assets/images/icons/icon-4.png)"></div>
		<div class="inner-container">
			<div class="auto-container">
				<div class="title-box centered">
					<h4>Schedule A Project</h4>
					<div class="text">Excepteur sint occaecat cupidatat non proident mollit any laboruys perspiciatis accusan <br> dolor que totams mollit anim est laborum sedut perspiciatis und omnis.</div>
				</div>
